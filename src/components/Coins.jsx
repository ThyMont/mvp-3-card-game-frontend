...
c17.789-3.467,34.585-12.651,47.394-27.342l36.121,31.409C233.154,252.087,214.257,265.047,193.203,272.635z"
    />
    <circle fill="currentColor" cx="93.372" cy="53.498" r="8" />
    <circle fill="currentColor" cx="38.758" cy="148.382" r="8" />
    <circle fill="currentColor" cx="93.623" cy="243.123" r="8" />
    <circle fill="currentColor" cx="203.105" cy="242.977" r="8.001" />
    <circle fill="currentColor" cx="257.717" cy="148.091" r="8" />
    <circle fill="currentColor" cx="202.853" cy="53.351" r="8" />
  </>
);

const Coin1Icon = createIcon({
  displayName: "Coin1Icon",
...
const Coin5Icon = createIcon({
  displayName: "Coin5Icon",
  viewBox: "0 0 296.477 296.477",
  color: "#FF0000",
  path: (
    <>
...
const Coin25Icon = createIcon({
  displayName: "Coin25Icon",
  viewBox: "0 0 296.477 296.477",
  color: "#008000",
  path: (
    <>
...
const Coin50Icon = createIcon({
  displayName: "Coin50Icon",
  viewBox: "0 0 296.477 296.477",
  color: "#0000FF",
  path: (
    <>
...
const Coin100Icon = createIcon({
  displayName: "Coin100Icon",
  viewBox: "0 0 296.477 296.477",
  color: "#000000",
  path: (
    <>
...
export { Coin1Icon, Coin5Icon, Coin25Icon, Coin50Icon, Coin100Icon, CoinIcon };
